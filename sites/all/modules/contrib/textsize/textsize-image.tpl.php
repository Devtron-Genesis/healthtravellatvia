...
<?php  if ($textsize_increase): ?>
  <li class="ts_increase"><?php print l('<img src="'. base_path() . path_to_theme() .'/images/increase_16.gif" width="16px" height="16px" alt="'. t('Increase') .'" class="ts_increase text_display_hidden ts_rollover" />', 'textsize/increase', array('attributes' => array('title' => $block_title .': '. t('Increase') .' +'. $increment .'%', 'class' => 'ts_increase text_display_hidden ts_rollover', 'rel' => 'nofollow'), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
<?php  if ($textsize_decrease): ?>
  <li class="ts_decrease"><?php print l('<img src="'. base_path() . path_to_theme() .'/images/decrease_16.gif" width="16px" height="16px" alt="'. t('Decrease') .'" class="ts_decrease text_display_hidden ts_rollover" />', 'textsize/decrease', array('attributes' => array('title' => $block_title .': '. t('Decrease') .' -'. $increment .'%', 'class' => 'ts_decrease text_display_hidden ts_rollover', 'rel' => 'nofollow'), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
<?php  if ($textsize_normal): ?>
  <li class="ts_normal"><?php print l('<img src="'. base_path() . path_to_theme() .'/images/normal_16.gif" width="16px" height="16px" alt="'. t('Normal') .'" class="ts_normal text_display_hidden ts_rollover" />', 'textsize/normal', array('attributes' => array('title' => $block_title .': '. t('Normal') .' ='. $normal .'%', 'class' => 'ts_normal text_display_hidden ts_rollover', 'rel' => 'nofollow'), 'query' => $dest, 'html' => TRUE)); ?></li>
<?php endif; ?>
</ul>
